  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center relative">
      <div className="space-y-8 animate-float">
        ...
        <p className="text-gray-300 text-xl leading-relaxed animate-fadeIn animation-delay-500 relative">
          <span className="absolute -left-4 top-0 w-1 h-full bg-gradient-to-b from-[#00F0FF] to-transparent"></span>
