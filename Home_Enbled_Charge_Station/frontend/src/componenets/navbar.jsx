    ...
    <header className="fixed w-full z-50 transition-all duration-300 bg-[#0D1117]/95 backdrop-blur-xl shadow-lg border-b border-[#00F0FF]/10">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/signup">
            <button className="px-5 py-1.5 rounded-full whitespace-nowrap bg-gradient-to-r from-[#8A2BE2] to-[#00F0FF] hover:opacity-90 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_rgba(0,240,255,0.3)] text-sm font-semibold tracking-wide uppercase">
              Sign Up
            </button>
          </Link>
        </div>
